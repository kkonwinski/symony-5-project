...
// Można usunąć łączenie z geterami i setterami, będzie dodwawać czas do kolumn ale trzeba dodać use TimestampableEntity;
//    /**
...
//    private $updatedAt;
    ...
    public function validate(ExecutionContextInterface $context, $payload)
    {
        if (stripos($this->getTitle(), 'the borg') !== false) {
            $context->buildViolation('To jest mój własny błąd dla tytułu')->atPath('title')->addViolation();
        }
    }
